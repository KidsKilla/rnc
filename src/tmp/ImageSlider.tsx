...
type PropsType = {
  ...
  position?: number;
  onPositionChanged?: (n: number) => void;
  onPress?: (o: Object) => void;
  customButtons?: (
    number: number,
    fn: (number: number, animated?: boolean) => void,
  ) => React.ReactNode;
  customSlide?: (s: Slide) => React.ReactNode;
  imagesWidth: number;
};
...
export class ImageSlider extends React.Component<PropsType, StateType> {
  state = {
    position: 0,
  ...
  _ref = null as ScrollView | null;
  _panResponder = {};
  public autoPlayFlag = false;
